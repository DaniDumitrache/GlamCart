                                        ...
                                        <div class="login-form-container">
                                            ...
                                            <div class="login-form">
                                                <div class="form-group">
                                                    <input type="text" id="Email" class="input-full" placeholder="Email" autocorrect="off" autocapitalize="off" autofocus>
                                                    <span id="ErrEmail" class="error"></span>
                                                </div>

                                                <div class="login-toggle-btn">
                                                    <div class="form-action-button">
                                                        <button id="ForgotPassword" class="theme-default-button">Submit</button>
                                                    </div>
