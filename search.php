                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-8 offset-lg-2 col-md-12">
                                    ...
                                    <h4 class="text-center page-search-title">Your search for "<?php if (isset($_GET['query'])) {
                                                                                                    echo $_GET['query'];
                                                                                                } ?>" revealed the following:</h4>


                                    <div class="page-search-bar">
                                        <form action="" method="get" class="page-search-form" role="search" style="position: relative;">

                                            <input type="search" name="query" value="<?php if (isset($_GET['query'])) {
                                                                                            echo $_GET['query'];
                                                                                        } ?>" placeholder="Search our store" class="" aria-label="Search our store" autocomplete="off">
                                            <button type="submit" class="page-search-button theme-default-button">
                                                <span class="fallback-text">Search</span>
                                            </button>
                                            <ul class="search-results home-two" style="position: absolute; left: 0px; top: 37.5px; display: none;"></ul>
                                        </form>
                                    </div>
                                </div>
                            </div>
             ...
             -->
                                    <div class="tab-content">
                                        <div class="row theme1">
                                            ...
                                            if (!isset($_GET['category']) && !isset($_GET['tags'])) {
                                                if (isset($_GET['query'])) {
                                                    $query = $_GET['query'];
                                                    $where = "WHERE `Product Name` LIKE '%$query%'";
                                                }
                                            } else {
                                                if (isset($_GET['query'])) {
                                                    $query = $_GET['query'];
                                                    $category = "WHERE `Product Name` LIKE '%$query%'";
                                                }
                                                ...
                                                $where = "WHERE `category` = '$category' or `tags` = '$tags'  or `Product Name` LIKE '%$query%'";
                                            }
