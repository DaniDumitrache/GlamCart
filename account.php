...
<body id="account" class="customer-logged-in template-account">
    <div class="wrapper">
                                ...
                                <div class="d-flex justify-content-center justify-content-sm-start align-items-center">
                                    ...
                                    <div class="media static-media ml-4 d-flex align-items-center">
                                        <div class="media-body">
                                            ...
                                            <div class="phone">
                                                <a href="(+123)4567890" class="text-white">
                                                    <i class="icon-call-out mr-1"></i>
                                                    (+123)4567890
                                                </a>
                                            </div>
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <nav class="navbar-top pb-2 pb-sm-0 position-relative">
                                    <ul class="d-flex justify-content-center justify-content-md-end align-items-center">
                                        ...
                                        <li>
                                            <a href="#">Setting <i class="ion ion-ios-arrow-down"></i></a>
                                        ...
                                        <li class="switcher-currency-trigger currency">
                                            <a href="#" class="currency-trigger"><span
                                                    class="current-currency">USD</span> <i
                                                    class="ion ion-ios-arrow-down"></i></a>

                                            <ul class="header-dropdown-menu switcher-dropdown" id="currencies">




                                                <li data-currency="USD" class="currency__item"><a
                                                        style="cursor: pointer">USD - US Dollar</a></li>




                                                <li data-currency="EUR" class="currency__item"><a
                                                        style="cursor: pointer">EUR - Euro</a></li>




                                                <li data-currency="GBP" class="currency__item"><a
                                                        style="cursor: pointer">GBP - British Pound</a></li>




                                                <li data-currency="INR" class="currency__item"><a
                                                        style="cursor: pointer">INR - Indian Rupee</a></li>




                                                <li data-currency="BDT" class="currency__item"><a
                                                        style="cursor: pointer">BDT - Bangladesh Taka</a></li>




                                                <li data-currency="JPY" class="currency__item"><a
                                                        style="cursor: pointer">JPY - Japan Yen</a></li>




                                                <li data-currency="CAD" class="currency__item"><a
                                                        style="cursor: pointer">CAD - Canada Dollar</a></li>




                                                <li data-currency="AUD" class="currency__item"><a
                                                        style="cursor: pointer">AUD - Australian Dollar</a></li>
                            ...
                            <div class="col-6 col-lg-2 col-xl-2">
                                <div class="logo">
                                    <a href="/" class="theme-logo">
                                        <img src="//cdn.shopify.com/s/files/1/0016/9626/8348/files/logo_6fdafa66-f2c3-4ba5-be86-599acbf8e48e_300x.png?v=1618308230"
                                            alt="Looki - Beauty &amp; Cosmetics eCommerce Shopify Theme">
                                    </a>
                                </div>
                            </div>
                            <div class="col-xl-8 col-lg-7 d-none d-lg-block">
                                <ul class="main-menu d-flex justify-content-center">
                                    <li><a href="/">Home <i class="ion-ios-arrow-down"></i></a>
                                        <ul class="sub-menu">
                                            <li><a
                                                    href="//?preview_theme_id=120916508732">Home
                                                    1</a></li>
                                            <li><a
                                                    href="//?preview_theme_id=120916705340">Home
                                                    2</a></li>
                                            <li><a
                                                    href="//?preview_theme_id=120916869180">Home
                                                    RTL </a></li>
                                        </ul>
                                    </li>
                                    <li class="position-static">
                                        <a href="/collections/all">shop <i class="ion-ios-arrow-down"></i></a>
                                        <ul class="mega-menu row">
                                            <li class="col-3">
                                                <ul>
                                                    <li class="mega-menu-title"><span>Shop Grid</span>
                                                        <ul>
                                                            <li><a
                                                                    href="//collections/all/?preview_theme_id=120222679100">Shop
                                                                    Grid 3 Column</a></li>
                                                            <li><a
                                                                    href="//collections/all/?preview_theme_id=120272977980">Shop
                                                                    Grid 4 Column</a></li>
                                                            <li><a
                                                                    href="//collections/all/?preview_theme_id=120222679100">Shop
                                            ...
                                            <li class="col-3">
                                                <ul>
                                                    <li class="mega-menu-title"><span>Shop List</span>
                                                        <ul>
                                                            <li><a
                                                                    href="//collections/all?view=list/?preview_theme_id=120222679100">Shop
                                                                    List</a></li>
                                                            <li><a
                                                                    href="//collections/all?view=list/?preview_theme_id=120222679100">Shop
                                                                    List Left Sidebar</a></li>
                                                            <li><a
                                                                    href="//collections/all?view=list/?preview_theme_id=120272977980">Shop
                                                                    List Right Sidebar</a></li>
                                                            <li><a href="/products/preorder-product">Preorder
                                                                    Product</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            ...
                                            <li class="col-3">
                                                <ul>
                                                    <li class="mega-menu-title"><span>Shop Single</span>
                                                        <ul>
                                                            <li><a href="/products/5-simple-product">Shop Single</a>
                                                            </li>
                                                            <li><a href="/products/3-variable-product">Shop Variable</a>
                                                            </li>
                                                            <li><a href="/products/7-sample-affiliate-product">Shop
                                                                    Affiliate</a></li>
                                                            <li><a href="/products/13-product-media-1">Shop Media</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            ...
                                            <li class="col-3">
                                                <ul>
                                                    <li class="mega-menu-title"><span>other pages</span>
                                                        <ul>
                                            ...
                                            <li class="col-6 mt-4">
                                                <a href="#" class="zoom-in overflow-hidden">
                                                    <img src="//cdn.shopify.com/s/files/1/0016/9626/8348/files/1_525x.png?v=1618480663"
                                                        alt="" />
                                                </a>
                                            </li>
                                            <li class="col-6 mt-4">
                                                <a href="#" class="zoom-in overflow-hidden">
                                                    <img src="//cdn.shopify.com/s/files/1/0016/9626/8348/files/2_525x.png?v=1618480692"
                                                        alt="" />
                                                </a>
                                            </li>
                                        </ul>
                                    ...
                                    <li><a href="/blogs/news">Blog <i class="ion-ios-arrow-down"></i></a>
                                        <ul class="sub-menu">
                                            <li><a href="#">Blog Grid <i class="ion-ios-arrow-right"></i> </a>
                                                <ul class="sub-menu">
                                                    <li><a
                                                            href="//blogs/news/?preview_theme_id=120222679100">Blog
                                                            Grid 3 column</a></li>
                                                    <li><a
                                                            href="//blogs/news/?preview_theme_id=120222679100">Blog
                                                            Grid 4 column</a></li>
                                            ...
                                            <li><a href="#">Blog List <i class="ion-ios-arrow-right"></i> </a>
                                                <ul class="sub-menu">
                                                    <li><a
                                                            href="//blogs/news/?preview_theme_id=120272977980">Blog
                                                            List Left Sidebar</a></li>
                                                    <li><a
                                                            href="//blogs/news/?preview_theme_id=120272977980">Blog
                                                            List Right Sidebar</a></li>
                                            ...
                                            <li><a
                                                    href="/blogs/news/it-is-a-long-established-fact-that-a-reader-will-1">Blog
                                                    Single <i class="ion-ios-arrow-right"></i> </a>
                                                <ul class="sub-menu">
                                                    <li><a
                                                            href="/blogs/news/the-standard-chunk-of-lorem-ipsum-used-since-1">Single
                                                            Blog</a></li>
                                                    <li><a
                                                            href="/blogs/news/the-standard-chunk-of-lorem-ipsum-used-since">Blog
                                                            Single Left Sidebar</a></li>
                                                    <li><a
                                                            href="//blogs/news/it-is-a-long-established-fact-that-a-reader-will-1/?preview_theme_id=120272977980">Blog
                                                ...
                                                <a class="offcanvas-toggle" href="#offcanvas-cart">
                                                    <span class="position-relative">
                                                        <i class="icon-bag"></i><span
                                                            class="badge cbdg1 bigcounter">1</span>
                                                    </span>
                                                </a>
                                            </li>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="offcanvas-submenu">
                                    ...
                                    <li><a href="//?preview_theme_id=120916508732">Home
                                            1</a></li>




                                    <li><a href="//?preview_theme_id=120916705340">Home
                                            2</a></li>




                                    <li><a href="//?preview_theme_id=120916869180">Home
                                            RTL </a></li>
                            ...
                            <li>
                                ...
                                <ul class="offcanvas-submenu">
                                    ...
                                    <li>
                                        <a href="/blogs/news/it-is-a-long-established-fact-that-a-reader-will-1"><span
                                                class="menu-text">Blog Single</span></a>
                                        <ul class="offcanvas-submenu">

                                            <li><a href="/blogs/news/the-standard-chunk-of-lorem-ipsum-used-since-1">Single
                                                    Blog</a></li>

                                            <li><a href="/blogs/news/the-standard-chunk-of-lorem-ipsum-used-since">Blog
                                                    Single Left Sidebar</a></li>
                        ...
                        <ul class="minicart-product-list single-cart-item-loop">
                            ...
                            <li>
                                <a class="image" href="/products/product-title-here-3?variant=39329676427324">
                                    <img src="//cdn.shopify.com/s/files/1/0016/9626/8348/products/04_c86ac07c-8c75-4a4c-ae29-76b5d203dd0f_small.jpg?v=1620554795"
                                        alt="">
                                </a>
                                <div class="content">
                                    <div class="mini-cart-text">
                                        <a class="title"
                                            href="/products/product-title-here-3?variant=39329676427324">The Cosmetics
                                            and Beauty brand Shoppe - red</a>
                                        <span class="quantity-price">
                                            Qty: 1 x <span class="amount"><span class=money>$39.00</span></span>
                                        </span>
                                    </div>
                                    <a href="javascript:void(0);" onclick="Shopify.removeItem(39329676427324)"
                                        class="remove">Ã—</a>
                                </div>
                            </li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumbs-inner section-title text-center">
                                ...
                                <h1 class="breadcrumbs-title title pb-4 text-dark text-capitalize">Account</h1>
                ...
                <div class="container">
                    ...
                    <div class="grid">
                        ...
                        <div class="grid__item one-third medium-down--one-whole mt-xs-30">
                            ...
                            <h3 class="h5">fagsdagasg sadgdsagsg</h3>
                            ...
                            <p><a href="/account/addresses">View Addresses (1)</a></p>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-30">
                                <div class="footer-widget mx-w-400">
                                    ...
                                    <p class="text mb-30">We are a team of professional designers and developers that
                                        create high quality wordpress plugins, Html, React Template.</p>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-30">
                                <div class="footer-widget">
                                    ...
                                    <p class="text description mb-20">Subcribe to the TheFace mailing list to receive
                                        update on new arrivals, special offers and other discount information.</p>

                                    <div class="nletter-form mb-35">
                                        <!-- Newsletter Form -->
                                        <form action="" class="form-inline position-relative" method="post"
                                            id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form"
                                            target="_blank">
                                            <input type="email" id="mail" class="form-control"
                                                value="fagdsghmdaskh@gmail.com" name="EMAIL"
                                                placeholder="email@example.com">
                                            <button type="submit" id="subscribe"
                                                class="btn news-letter-btn text-capitalize">Sign up</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class=" coppy-right-2 col-12  col-md-6 col-lg-6  ">
                                <div class="coppy-right text-left mt-3 mt-md-0">
                                    <p>Copyright Â© <a href="#" title="#"><strong>HasThemes</strong></a>Â All Right
                                        Reserved.</p>
                                </div>
                            </div>
                            <div class=" payment-imge col-12 col-md-6 col-lg-6 ">
                                <div class="imge text-right"><img
                                        src="//cdn.shopify.com/s/files/1/0016/9626/8348/files/1_26fcc773-a505-482c-af2d-0e04bb504ca0_large.png?v=1618650787"
                                        alt="" /></div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Necessary JS -->
        <script
            src="//cdn.shopify.com/s/files/1/0016/9626/8348/t/8/assets/fastclick.min.js?v=29723458539410922371636534405"></script>
        <script
            src="//cdn.shopify.com/s/files/1/0016/9626/8348/t/8/assets/timber.js?v=147794995694520970281636534455"></script>
        ...
        <script
            src="//cdn.shopify.com/s/files/1/0016/9626/8348/t/8/assets/jquery.currencies.min.js?v=35452912321688254271636534417"></script>
